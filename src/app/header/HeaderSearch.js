...
const HeaderSearch = () => {
  return (
    <div className="bg-gray-800 text-white p-2 flex flex-col md:flex-row justify-between items-center px-5 lg:px-28">
      <label
        htmlFor="logo"
        className="cursor-pointer flex items-center mb-2 md:mb-0"
      >
        <Image priority={true} src={logo} alt="logo" className="h-9 md:h-11" />
        <div className="ml-2 md:ml-5 text-sm lg:text-xl">
          Y A C H T N E E D S
        </div>
      </label>
